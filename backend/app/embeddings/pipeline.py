...
from sentence_transformers import (
    SentenceTransformer,  # SentenceTransformer is a class from the sentence_transformers library
    # that allows you to load pre-trained models for generating sentence embeddings. It provides an
    # easy-to-use interface for encoding sentences into fixed-size vectors, which can be used for
    # various natural language processing tasks such as semantic similarity, clustering, and
    # classification.
)
...
class EmbeddingPipeline:
    ...
    at instantiation and reused across all embed() calls.
    That avoids reloading the model on every request.
    """
    ...
    def __init__(self, model_name: str = DEFAULT_MODEL):
        ...
        self.model = SentenceTransformer(
            model_name
        )  # Load the pre-trained model specified by model_name. This model will be used to generate
    ...
    def embedding_dimension(self) -> int:
        ...
        """
        return cast(int, self.model.get_embedding_dimension())
